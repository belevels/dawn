...
class CarouselComponent extends SlideshowComponent { 
  ...
  autoRotateSlides() {
    ...
    if (window.matchMedia("(min-width: 990px)").matches) {
      var slideScrollPosition = this.currentPage === (this.slidesPerPage - this.TotalSlidesDesktop.textContent) ? 0 : this.slider.scrollLeft + this.slider.querySelector('.slideshow__slide').clientWidth; // desktop
